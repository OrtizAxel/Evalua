...
namespace Evalua
{
    public class Lexico : Token
    {
        ...
        {
            linea = 1;
            string path = "C:\\Users\\Axrro\\OneDrive\\Documentos\\Escuela\\Tareas\\Lenguajes y Automatas II\\Evalua\\prueba.cpp";
            bool existencia = File.Exists(path);
            log = new StreamWriter("C:\\Users\\Axrro\\OneDrive\\Documentos\\Escuela\\Tareas\\Lenguajes y Automatas II\\Evalua\\prueba.Log"); 
            log.AutoFlush = true;
